...
public class Entity {
    ...
    public void goShopping(ShopService a,Scanner sc){
        ...
        a.fiyatHesapla(selection,miktar,ka,dt);
        System.out.println();
    ...
    public void odemeIcinKasa(Kasa ks,Scanner sc){
        System.out.print("Toplam Borcunuz : "+ks.getOdenecekToplamBorc());
        System.out.println();
        boolean isOdem=false;
        do {
            System.out.print("Lutfen Vereceginiz Miktari Giriniz  : ");
            double musterininVerdigi = sc.nextDouble();
            if (musterininVerdigi < ks.getOdenecekToplamBorc()) {
                System.out.println((ks.getOdenecekToplamBorc() - musterininVerdigi) + " TL eksik odeme yaptiniz... " +
